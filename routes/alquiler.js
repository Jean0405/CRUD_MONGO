...
import { appMiddlewareAlquilerVerify } from "../middleware/proxyAlquiler.js";

const ALQUILER = Router();
let db = await connectDB();

//-----------------LISTAR LOS ALQUILER QUE SE ENCUENTREN ACTIVOS-----------------
ALQUILER.get("/", appMiddlewareAlquilerVerify, async (req, res) => {
  try {
...
ALQUILER.get(
  "/disponible/capacidad/:capacidad",
  appMiddlewareAlquilerVerify,
  async (req, res) => {
